...
# Gyógyszerérzékenység fázisonként
parameters_1 = [(0.25, 0, 0), (0, 0.25, 0), (0, 0, 0.25), (0.3, 0, 0.1), (0.05, 0, 0.35)]
parameters_2 = [3, 5, 7, 9, 11, 13, 15]  # adagolások száma / sűrűsége
...
for i in range(len(parameters_1)):  # sorokban treatment frequency
    for j in range(len(parameters_2)):
        t, r, y, g, m, d = logdelay(k_c=parameters_1[i], treatment_freq=parameters_2[j])
...
plt.xlabel('Treatment frequency (hours between two treatments)')
