...
def logdelay(drug_0=2.3869/4, k_c=(0, 0, 0.9), delta=1.83281, protocol=[0, 24, 48, 72]):
    ...
    drug_decay = np.log(2) / 30.8  # 30.8  # derived from Joerger et al.
    ...
    end_time = protocol[-1] + 24 if protocol[-1] != 0 else 100
    time_step = 0.05
    drug_step = 0.05
    Data = []
